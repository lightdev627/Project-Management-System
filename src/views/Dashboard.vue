            ...
            <a-row gutter="16">
              ...
              <a-col :span="4">
                <a-card
                  title="Member"
                  bordered
                  bodyStyle="padding: 8px; min-height: 260px;"
                >
                    ...
                    <ul class="fantastic-member-list">
                      ...
                      >
                        <label class="fantastic-checkbox-label">
                          ...
                          <span class="fantastic-member-name">{{
                            member
                          }}</span>
                        </label>
                      </li>
      ...
      <div class="pivot-section">
        ...
        <a-row gutter="16" style="margin-bottom: 16px">
          <a-col :span="8">
            ...
            >
              <a-table
                :columns="pivotColumns1"
                :dataSource="pivotData1"
                size="small"
                :pagination="false"
                bordered
          ...
          <a-col :span="8">
            ...
            >
              <a-table
                :columns="pivotColumns2"
                :dataSource="pivotData2"
                size="small"
                :pagination="false"
                bordered
                style="flex: 1; overflow: auto"
          ...
          <a-col :span="8">
            ...
            >
              <a-table
                :columns="pivotColumns3"
                :dataSource="pivotData3"
                size="small"
                :pagination="false"
                bordered
                style="flex: 1; overflow: auto"
        ...
        <a-row gutter="16">
          <a-col :span="24">
            ...
            >
              <a-table
                :columns="pivotColumns4"
                :dataSource="pivotData4"
                size="small"
                :pagination="false"
                bordered
                style="flex: 1; overflow: auto"

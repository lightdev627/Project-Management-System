<template>
	<a-layout-sider
		...
		:style="{ backgroundColor: 'white'}">
			<div class="brand"><span>Project Management</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/timeline">
						<span class="icon">
							<svg width="30" height="30" viewBox="-7.5 -7.5 30.00 30.00" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H1V14H15V15H0V0ZM2 2H5V3H2V2ZM3 5H8V6H3V5ZM5 8H8V9H5V8ZM8 11H15V12H8V11Z" fill="#111827" stroke-width="2"/>
							</svg>
						</span>
				...
				<a-menu-item>
					<router-link to="/planner">
						...
						<span class="label">Monthly Planner</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
...
.sider-primary :deep(.ant-menu-item-only-child) {
...
.sider-primary :deep(.ant-menu-item:last-child),
.sider-primary :deep(.ant-menu-item-only-child:last-child) {

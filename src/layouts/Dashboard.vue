<template>
	<div>
		<a-layout class="layout-dashboard" id="layout-dashboard" :class="[navbarFixed ? 'navbar-fixed' : '', ! sidebarCollapsed ? 'has-sidebar' : 'sidebar-collapsed', layoutClass]">
			<DashboardSidebar
			...
			<a-layout :class="sidebarCollapsed ? 'collapsed' : 'expanded'">
				<DashboardHeader
					:sidebarCollapsed="sidebarCollapsed"
